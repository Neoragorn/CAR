...
private String nom;
//Mot de passe d'un client utilisé par celui ci pour se connceter au serveur
private String pwd;
//Variable booléene qui indique l'état du client connecté ou pas
...
//_____________________________________________Méthodes utilisées pour la mise à jour de l'interface graphique du client

//********************************Utilisé pour ajouter un client connecté au JList
...
//********************************Utilisée pour supprimer un client qui a déconnecté du JList
...
public void initialiser(){
  ...
  private void jbInit() throws Exception {
    ...
    //Création des relations logiques entre les JRadioButton
    ...
    //Création des objets de la police
...
//_________________________________Classe interne utilisée pour la gestion des évenements engendrés par les boutons radios
...
//_________________________________Classe interne utilisée pour la gestion des évenements engendrés par le bouton Envoyer
